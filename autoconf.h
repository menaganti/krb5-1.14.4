...
#define DEFCKTNAME "FILE:/home/buildUser/work/dge200/output/android/var/krb5/user/%{euid}/client.keytab"
...
//struct ns_msg;
//int ns_initparse (const u_char *, int , struct ns_msg *);
...
#define PACKAGE_STRING "Kerberos 5 1.14.4"
